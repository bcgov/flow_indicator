...
# Load in data.
flow_dat = read_rds('app/www/annual_flow_dat.rds') %>% 
  as_tibble()
```
...
longdat = stdat %>% 
  pivot_longer(cols = c(Average,DoY_50pct_TotalQ,
                        Min_7_Day,Min_7_Day_DoY),
...
a = plot_function(plotdat, chosen_var = 'Average')
b = plot_function(plotdat, chosen_var = 'Day of 50% Annual Flow')
c = plot_function(plotdat, chosen_var = '7-Day Low Flow Day of Year')
