...
year of available data. We removed years that had more than 2% daily missing 
...
stations identified increasing average annual flows, of which `r average_cat$n[average_cat$category == "> 5% increase"]` were increasing by more than 5% per decade. In contrast, `r average_direction$n[average_direction$direction == "negative"]` displayed decreasing average annual flows, while the remaining `r average_direction$n[average_direction$direction == "no change"]` were either less than 1% a year or had non-significant trends.
...
-   The majority of locations did not show significant trends forthe start date of the low flow period. Of those that 
